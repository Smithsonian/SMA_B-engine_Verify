...
typedef struct vdif_header {
	...
	uint32_t complex:1;
	// word4
	//uint32_t eud0:24; //deleted by weiyu
	//uint32_t edv:8; //deleted by weiyu

   //added by weiyu
//	uint64_t B_engine_header_C: 8;
//	uint64_t B_engine_header_F: 3;
//	uint64_t B_engine_header_clock: 29;
//	uint64_t B_engine_header_second: 24;

//	uint32_t B_engine_header_C: 8;
//	uint32_t B_engine_header_F: 3;
//	uint32_t B_engine_header_clock: 29;
//	uint32_t B_engine_header_second: 24;
